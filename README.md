...
1. [ShopperTrail Quick Overview](#shoppertrail-quick-overview)
2. [Prerequisites](#prerequisites)
3. [Instructions](#instructions)
4. [Scenario ID List](#scenario-id-list)

   * [ID 1. Homepage Load & Visual Check](#id-1-homepage-load--visual-check)
   * [ID 2. About ShopperTrail Page Content & Media](#id-2-about-shoppertrail-page-content--media)
   * [ID 3. Login/Logout (Seeded Account)](#id-3-loginlogout-seeded-account)
